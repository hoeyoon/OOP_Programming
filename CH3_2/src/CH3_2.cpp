 ...
 * 프로젝트 및 소스파일 생성
 ******************************************************************************/
// 기존의 CH2, CH3_1 프로젝트를 수행했던 이클립스 작업공간(workspace)에서 다음을 실행하라.
// 1) 메뉴 [File]->[New]->[C/C++ Project] 한 후 새로운 프로젝트 CH3_2를 만들어라.
// 2) 메뉴 [File]->[New]->[Source Folder] 한 후 폴더 이름으로 src를 지정하여 생성하라.
// 3) 메뉴 [File]->[New]->[Source File]한 후 파일 이름으로 ch3_2.cpp를 지정하라.
